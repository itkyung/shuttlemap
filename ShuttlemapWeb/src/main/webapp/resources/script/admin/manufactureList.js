var fv_codeType = 'MANUFACTURE';

$(document).ready(function(){
	
	var url = _requestPath + "/admin/getManufactures";
...
/*	var params = {};
	...
	$("#codeSearchResultTable").jqGrid({
		...
		colNames : ['id','분류','제조사명1','제조사명2','생성일','수정일','사용여부','수정/삭제'],
		colModel : [
		...
		caption : '제조사 관리',hidegrid : false,height : 300
	});
...
function setCommCodeForm(obj, data, acc) { 
	...
	$(obj).find("#ed_value1").html("제조사명1");
	$(obj).find("#ed_value2").html("제조사명2");
